...
{
	print("|----------------------------------|");
	print("| BLOKGEDONG Premiere | A4-RC-Version |");
	print("|----------------------------------|");
}
	...
	else if(checkpointid == pTutorialRCP[playerid] && IsPlayerInDynamicRaceCP(playerid, pTutorialRCP[playerid]))
	{
		switch(pTutorialStep[playerid])
		{
			...
			case 3:
			{
				...
				SendClientMessage(playerid, X11_YELLOW, "[Tutorial] Inilah salah satu "CYAN"GYM "YELLOW"yang ada di server BLOKGEDONG, dekati alat dan tekan "RED"tombol 'Y'.");
				SendClientMessage(playerid, X11_YELLOW, "------ # Akhir Informasi ------");
			...
			case 12: //carnival
			{
				...
				SendClientMessage(playerid, X11_YELLOW, "[Tutorial] Tidak hanya memancing, kamu juga dapat berburu rusa di BLOKGEDONG. Beli alat terlebih dahulu di "CYAN"Warung.");
	...
	if(!ispassenger)
	{
		...
		if(IsLSPDVehicle(vehicleid))
		{
			if(AccountData[playerid][pFaction] != FACTION_LSPD)
			{
				...
				ShowTDN(playerid, NOTIFICATION_ERROR, "Anda bukan bagian dari Kepolisian BLOKGEDONG!");
			}
		}
		...
		if(IsLSFDVehicle(vehicleid))
		{
			if(AccountData[playerid][pFaction] != FACTION_LSFD)
			{
				...
				GetPlayerPos(playerid, slx, sly, slz);
				SetPlayerPos(playerid, slx, sly, slz + 3.5);
				ShowTDN(playerid, NOTIFICATION_ERROR, "Anda bukan bagian dari Paramedis BLOKGEDONG!");
			}
		}
		...
		if(IsSAGOVVehicle(vehicleid))
		{
			if(AccountData[playerid][pFaction] != FACTION_SAGOV)
			{
				...
				GetPlayerPos(playerid, slx, sly, slz);
				SetPlayerPos(playerid, slx, sly, slz + 3.5);
				ShowTDN(playerid, NOTIFICATION_ERROR, "Anda bukan bagian dari Pemerintah Kota BLOKGEDONG!");
			}
		}
		...
		if(IsFOX11LAVehicle(vehicleid))
		{
			if(AccountData[playerid][pFaction] != FACTION_FOX11)
			{
				...
				GetPlayerPos(playerid, slx, sly, slz);
				SetPlayerPos(playerid, slx, sly, slz + 3.5);
				ShowTDN(playerid, NOTIFICATION_ERROR, "Anda bukan bagian dari Pewarta BLOKGEDONG!");
			}
		}
...
public OnPlayerStateChange(playerid, newstate, oldstate)
{
	...
	if(newstate == PLAYER_STATE_DRIVER) //naik
	{
		...
		if(IsAMowingSidejobVeh(SavingVehID[playerid]))
		{
            ...
            {
                Dialog_Show(playerid, "SidejobMowing", DIALOG_STYLE_MSGBOX, ""BLOKGEDONG"BLOKGEDONG "WHITE"- Sidejob Mowing", "Apakah anda ingin memulai tugas mowing?\nAnda akan menerima bayaran berdasarkan jumlah rumput yang anda potong.", "Yes", "No");
            }
		}
		...
		if(IsASweeperSidejobVeh(SavingVehID[playerid]))
		{
            ...
            {
                Dialog_Show(playerid, "SidejobSweeper", DIALOG_STYLE_MSGBOX, ""BLOKGEDONG"BLOKGEDONG "WHITE"- Sidejob Sweeper", "Apakah anda ingin memulai tugas sweeper?\nAnda akan menerima bayaran setelah membersihkan jalanan.", "Yes", "No");
            }
		}
		...
		if(IsAForkliftSidejobVeh(SavingVehID[playerid]))
		{
            ...
            {
                Dialog_Show(playerid, "SidejobForklift", DIALOG_STYLE_MSGBOX, ""BLOKGEDONG"BLOKGEDONG "WHITE"- Sidejob Forklift", "Apakah anda ingin memulai tugas forklift?\nAnda akan menerima bayaran setelah membongkar muat 10 crates.", "Yes", "No");
            }
		}
		...
		if(IsATrashCollectorSidejobVeh(SavingVehID[playerid]))
		{
            ...
            {
                Dialog_Show(playerid, "SidejobTrashCollector", DIALOG_STYLE_MSGBOX, ""BLOKGEDONG"BLOKGEDONG "WHITE"- Sidejob Trash Collector", "Apakah anda ingin memulai tugas trash collector?\nAnda akan menerima bayaran setelah mengangkut 25 trash.", "Yes", "No");
            }
		}
		...
		if(SavingVehID[playerid] == g_CarstealCarPhysic[playerid])
		{
			if(g_CarstealCarPhysic[playerid] != INVALID_VEHICLE_ID)
			{
				...
				ShowFivemNotify(playerid, "BLOKGEDONG Premiere~n~CAR STEAL", "Anda telah menemukan kendaraannya, kembalikan kepada gangster", "hud:radar_qmark", 25);
				...
				if(!g_CarstealCarFound[playerid])
				{
					...
					{
						ShowFivemNotify(i, "BLOKGEDONG Premiere~n~CAR STEAL", sprintf("Pencurian kendaraan %s berlangsung di %s", GetVehicleModelName(GetVehicleModel(g_CarstealCarPhysic[playerid])), GetLocation(crstlX, crstlY, crstlZ)), "hud:radar_qmark", 25);
...
OnPlayerUseItem(playerid, const name[])
{
	...
	else if(!strcmp(name, "Karung Goni"))
	{
		...
		if(count == 0) 
		{
			...
			return Dialog_Show(playerid, "UnusedDialog", DIALOG_STYLE_MSGBOX, ""BLOKGEDONG"BLOKGEDONG "WHITE"- Karung Goni", "Tidak ada pemain terdekat!", "Tutup", "");
		}

		Dialog_Show(playerid, "Blindfold", DIALOG_STYLE_LIST, ""BLOKGEDONG"BLOKGEDONG "WHITE"- Karung Goni", frmxt, "Pilih", "Batal");
	}
	...
	else if(!strcmp(name, "Disposable Phone"))
	{
		...
		Dialog_Show(playerid, "DisposPhoneCatalog", DIALOG_STYLE_TABLIST_HEADERS, ""BLOKGEDONG"BLOKGEDONG "WHITE"- Order Gun & Equipment", 
        "Item\tPrice\n\
		Colt-45\t$3,000\n\
	...
	else if(!strcmp(name, "Pilox"))
	{
		...
		Dialog_Show(playerid, "GraffitiAdd", DIALOG_STYLE_INPUT, ""BLOKGEDONG"BLOKGEDONG "WHITE"- Add Graffiti", 
	...
	else if(!strcmp(name, "Changename Card"))
	{
		...
		Dialog_Show(playerid, "ChangeName", DIALOG_STYLE_INPUT, ""BLOKGEDONG"BLOKGEDONG "WHITE"- Change Name", 
...
public OnPlayerClickTextDraw(playerid, Text:clickedid)
{
	...
	else if(clickedid == InventTD[5]) //tombol give item inventory
	{
		...
		{
			PlayerPlaySound(playerid, 5206, 0.0, 0.0, 0.0);
			return Dialog_Show(playerid, "UnusedDialog", DIALOG_STYLE_MSGBOX, ""BLOKGEDONG"BLOKGEDONG "WHITE"- Give Item", "Tidak ada pemain terdekat!", "Tutup", "");
		}

		Dialog_Show(playerid, "InventoryGive", DIALOG_STYLE_LIST, ""BLOKGEDONG"BLOKGEDONG "WHITE"- Give Item", frmxt, "Pilih", "Batal");
	...
	{
		if(!AVC_PConnected[playerid]) return Kick(playerid);
		Dialog_Show(playerid, "ATMWithdraw", DIALOG_STYLE_INPUT, ""BLOKGEDONG"BLOKGEDONG "WHITE"- Withdraw", 
		"Mohon masukkan berapa jumlah yang ingin ditarik:", "Tarik", "Batal");
	}
	else if(clickedid == ATMTD[21]) //deposit ATM
	{
		if(!AVC_PConnected[playerid]) return Kick(playerid);
		Dialog_Show(playerid, "ATMDeposit", DIALOG_STYLE_INPUT, ""BLOKGEDONG"BLOKGEDONG "WHITE"- Deposit", 
		"Mohon masukkan berapa jumlah yang ingin disimpan:", "Depo", "Batal");
	}
	else if(clickedid == ATMTD[20]) //transfer ATM
	{
		if(!AVC_PConnected[playerid]) return Kick(playerid);
		Dialog_Show(playerid, "ATMTransfer", DIALOG_STYLE_INPUT, ""BLOKGEDONG"BLOKGEDONG "WHITE"- Transfer", 
	...
	else if(clickedid == ATMTD[35]) //quick withdraw 10
	{
		...
		Dialog_Show(playerid, "ATMQuickMenu", DIALOG_STYLE_MSGBOX, ""BLOKGEDONG"BLOKGEDONG "WHITE"- Quick Withdraw", ""WHITE"Apakah anda yakin ingin menarik uang senilai "GREEN"$10,000 "WHITE"dari saldo rekening?\nPilih "YELLOW"'lanjut' "WHITE"untuk melanjutkan transaksi ini!", "Lanjut", "Batal");
	}
	else if(clickedid == ATMTD[36]) //quick withdraw 50
	{
		if(!AVC_PConnected[playerid]) return Kick(playerid);
		AccountData[playerid][pTempValue2] = 2;
		Dialog_Show(playerid, "ATMQuickMenu", DIALOG_STYLE_MSGBOX, ""BLOKGEDONG"BLOKGEDONG "WHITE"- Quick Withdraw", ""WHITE"Apakah anda yakin ingin menarik uang senilai "GREEN"$50,000 "WHITE"dari saldo rekening?\nPilih "YELLOW"'lanjut' "WHITE"untuk melanjutkan transaksi ini!", "Lanjut", "Batal");
	}
	else if(clickedid == ATMTD[38]) //quick withdraw 25
	{
		if(!AVC_PConnected[playerid]) return Kick(playerid);
		AccountData[playerid][pTempValue2] = 3;
		Dialog_Show(playerid, "ATMQuickMenu", DIALOG_STYLE_MSGBOX, ""BLOKGEDONG"BLOKGEDONG "WHITE"- Quick Withdraw", ""WHITE"Apakah anda yakin ingin menarik uang senilai "GREEN"$250,000 "WHITE"dari saldo rekening?\nPilih "YELLOW"'lanjut' "WHITE"untuk melanjutkan transaksi ini!", "Lanjut", "Batal");
	}
	else if(clickedid == ATMTD[37]) //quick withdraw 500
	{
		AccountData[playerid][pTempValue2] = 4;
		Dialog_Show(playerid, "ATMQuickMenu", DIALOG_STYLE_MSGBOX, ""BLOKGEDONG"BLOKGEDONG "WHITE"- Quick Withdraw", ""WHITE"Apakah anda yakin ingin menarik uang senilai "GREEN"$500,000 "WHITE"dari saldo rekening?\nPilih "YELLOW"'lanjut' "WHITE"untuk melanjutkan transaksi ini!", "Lanjut", "Batal");
	}
	...
	else if(clickedid == ATMTD[39]) //quick deposit 10
	{
		...
		Dialog_Show(playerid, "ATMQuickMenu", DIALOG_STYLE_MSGBOX, ""BLOKGEDONG"BLOKGEDONG "WHITE"- Quick Deposit", ""WHITE"Apakah anda yakin ingin deposit uang senilai "GREEN"$10,000 "WHITE"ke saldo rekening?\nPilih "YELLOW"'lanjut' "WHITE"untuk melanjutkan transaksi ini!", "Lanjut", "Batal");
	}
	else if(clickedid == ATMTD[40]) //quick deposit 50
	{
		if(!AVC_PConnected[playerid]) return Kick(playerid);
		AccountData[playerid][pTempValue2] = 6;
		Dialog_Show(playerid, "ATMQuickMenu", DIALOG_STYLE_MSGBOX, ""BLOKGEDONG"BLOKGEDONG "WHITE"- Quick Deposit", ""WHITE"Apakah anda yakin ingin deposit uang senilai "GREEN"$50,000 "WHITE"ke saldo rekening?\nPilih "YELLOW"'lanjut' "WHITE"untuk melanjutkan transaksi ini!", "Lanjut", "Batal");
	}
	else if(clickedid == ATMTD[42]) //quick deposit 25
	{
		if(!AVC_PConnected[playerid]) return Kick(playerid);
		AccountData[playerid][pTempValue2] = 7;
		Dialog_Show(playerid, "ATMQuickMenu", DIALOG_STYLE_MSGBOX, ""BLOKGEDONG"BLOKGEDONG "WHITE"- Quick Deposit", ""WHITE"Apakah anda yakin ingin deposit uang senilai "GREEN"$250,000 "WHITE"ke saldo rekening?\nPilih "YELLOW"'lanjut' "WHITE"untuk melanjutkan transaksi ini!", "Lanjut", "Batal");
	}
	else if(clickedid == ATMTD[41]) //quick deposit 500
	{
		AccountData[playerid][pTempValue2] = 8;
		Dialog_Show(playerid, "ATMQuickMenu", DIALOG_STYLE_MSGBOX, ""BLOKGEDONG"BLOKGEDONG "WHITE"- Quick Deposit", ""WHITE"Apakah anda yakin ingin deposit uang senilai "GREEN"$500,000 "WHITE"ke saldo rekening?\nPilih "YELLOW"'lanjut' "WHITE"untuk melanjutkan transaksi ini!", "Lanjut", "Batal");
	}
	...
	else if(clickedid == RadialTD[3]) //invoice
	{
		...
		if(count == 0)
		{
			Dialog_Show(playerid, "UnusedDialog", DIALOG_STYLE_MSGBOX, ""BLOKGEDONG"BLOKGEDONG "WHITE"- Unpaid Invoice", 
		...
		else
		{
			...
			Dialog_Show(playerid, "InvoicePay", DIALOG_STYLE_TABLIST_HEADERS, ""BLOKGEDONG"BLOKGEDONG "WHITE"- Unpaid Invoice", 
			xjjs, "Bayar", "Batal");
		}
	}
	//radialtd yang ke 2
	...
	else if(clickedid == RadialTD2[4]) //dokument
	{
		...
		Dialog_Show(playerid, "MyDocuments", DIALOG_STYLE_LIST, ""BLOKGEDONG"BLOKGEDONG "WHITE"- Dokumen", 
	...
	else if(clickedid == RadialFashionTD[23]) //helmet/topi
	{
		...
		Dialog_Show(playerid, "ToysEdit", DIALOG_STYLE_TABLIST_HEADERS, ""BLOKGEDONG"BLOKGEDONG "WHITE"- Edit Fashion (Hat/Helmet)", string, "Pilih", "Kembali");
	}
	else if(clickedid == RadialFashionTD[24]) //kacamata
	{
		...
		Dialog_Show(playerid, "ToysEdit", DIALOG_STYLE_TABLIST_HEADERS, ""BLOKGEDONG"BLOKGEDONG "WHITE"- Edit Fashion (Kacamata)", string, "Pilih", "Kembali");
	}
	else if(clickedid == RadialFashionTD[25]) //aksesoris
	{
		...
		Dialog_Show(playerid, "ToysEdit", DIALOG_STYLE_TABLIST_HEADERS, ""BLOKGEDONG"BLOKGEDONG "WHITE"- Edit Fashion (Aksesoris)", string, "Pilih", "Kembali");
	}
	else if(clickedid == RadialFashionTD[26]) //tas/koper
	{
		...
		Dialog_Show(playerid, "ToysEdit", DIALOG_STYLE_TABLIST_HEADERS, ""BLOKGEDONG"BLOKGEDONG "WHITE"- Edit Fashion (Tas/Koper)", string, "Pilih", "Kembali");
	}
	//--------- Kendaraan --------
	...
	else if(clickedid == RadialVehTD[13]) //bagasi
	{
		...
		foreach(new carid : PvtVehicles)
		{
			if(vehid == PlayerVehicle[carid][pVehPhysic])
			{
				...
				Dialog_Show(playerid, "VehicleStorage", DIALOG_STYLE_LIST, sprintf("Bagasi Kendaraan "YELLOW"%s "BLOKGEDONG"- %s", GetVehicleModelName(PlayerVehicle[carid][pVehModelID]), PlayerVehicle[carid][pVehPlate]), "Simpan Barang\nAmbil Barang", "Pilih", "Batal");
			}
		}
	}
	...
	else if(clickedid == RadialVehTD[15]) //trunk
	{
		...
		Dialog_Show(playerid, "VehicleTrunk", DIALOG_STYLE_LIST, ""BLOKGEDONG"BLOKGEDONG "WHITE"- Trunk", 
	...
	else if(clickedid == RadialCardTD[25]) //lihat KTP
	{
		...
		{
			Dialog_Show(playerid, "UnusedDialog", DIALOG_STYLE_MSGBOX, ""BLOKGEDONG"BLOKGEDONG "WHITE"- Kartu Tanda Penduduk", 
	...
	else if(clickedid == RadialCardTD[22]) //tunjuk KTP
	{
        ...
        if(count > 0)
		{
            Dialog_Show(playerid, "ShowToIDCard", DIALOG_STYLE_LIST, ""BLOKGEDONG"BLOKGEDONG "WHITE"- Tunjukkan KTP", 
			frmxt, "Pilih", "Batal");
		}
	}
	else if(clickedid == RadialCardTD[23]) //lihat lisensi
	{
		...
		{
			Dialog_Show(playerid, "UnusedDialog", DIALOG_STYLE_MSGBOX, ""BLOKGEDONG"BLOKGEDONG "WHITE"- Licenses", 
	...
	else if(clickedid == RadialCardTD[24]) //tunjuk lisensi
	{
        ...
        if(count > 0)
		{
            Dialog_Show(playerid, "ShowToLicense", DIALOG_STYLE_LIST, ""BLOKGEDONG"BLOKGEDONG "WHITE"- Tunjukkan Lisensi", 
			frmxt, "Pilih", "Batal");
		}
	}
...
public OnDynamicPlayerTextdrawClicked(playerid, PlayerText:playertextid)
{
	...
	if(playertextid == InventWeightTD[playerid][3]) //tombol set jumlah item inventory yang akan diberi
	{
		...
		Dialog_Show(playerid, "InventorySetValue", DIALOG_STYLE_INPUT, ""BLOKGEDONG"BLOKGEDONG "WHITE"- Set Value", "Mohon masukkan jumlah item yang akan diberikan:", "Set", "Batal");
		PlayerPlaySound(playerid, 1052, 0.0, 0.0, 0.0);
	}
	//td rental fagio
	...
	if(playertextid == BLOKGEDONG_GovTD[playerid][8]) // Close
	{
		HideGovTD(playerid);
		ShowHBETD(playerid);
		ShowStatsTD(playerid);				
	...
	if(playertextid == BLOKGEDONG_GovTD[playerid][3]) // Ambil Pekerjaan
	{
		HideGovTD(playerid);
		ShowHBETD(playerid);
		ShowStatsTD(playerid);
	...
	if(playertextid == BLOKGEDONG_GovTD[playerid][5]) // Buat KTP
	{
		HideGovTD(playerid);
		ShowHBETD(playerid);
		ShowStatsTD(playerid);
	...
	{
		Dialog_Show(playerid, "SetSemenValue", DIALOG_STYLE_INPUT, ""BLOKGEDONG"BLOKGEDONG "WHITE"- Batching Plant", "Mohon masukkan jumlah agregat yang akan ditetapkan:", "Set", "Batal");
		PlayerPlaySound(playerid, 1052, 0.0, 0.0, 0.0);
	}
	else if(playertextid == pJobMixTD[playerid][6])
	{
		Dialog_Show(playerid, "SetPasirValue", DIALOG_STYLE_INPUT, ""BLOKGEDONG"BLOKGEDONG "WHITE"- Batching Plant", "Mohon masukkan jumlah agregat yang akan ditetapkan:", "Set", "Batal");
		PlayerPlaySound(playerid, 1052, 0.0, 0.0, 0.0);
	}
	else if(playertextid == pJobMixTD[playerid][7])
	{
		Dialog_Show(playerid, "SetKrikilAValue", DIALOG_STYLE_INPUT, ""BLOKGEDONG"BLOKGEDONG "WHITE"- Batching Plant", "Mohon masukkan jumlah agregat yang akan ditetapkan:", "Set", "Batal");
		PlayerPlaySound(playerid, 1052, 0.0, 0.0, 0.0);
	}
	else if(playertextid == pJobMixTD[playerid][8])
	{
		Dialog_Show(playerid, "SetKrikilBValue", DIALOG_STYLE_INPUT, ""BLOKGEDONG"BLOKGEDONG "WHITE"- Batching Plant", "Mohon masukkan jumlah agregat yang akan ditetapkan:", "Set", "Batal");
		PlayerPlaySound(playerid, 1052, 0.0, 0.0, 0.0);
	}
	else if(playertextid == pJobMixTD[playerid][9])
	{
		Dialog_Show(playerid, "SetAirValue", DIALOG_STYLE_INPUT, ""BLOKGEDONG"BLOKGEDONG "WHITE"- Batching Plant", "Mohon masukkan jumlah agregat yang akan ditetapkan:", "Set", "Batal");
		PlayerPlaySound(playerid, 1052, 0.0, 0.0, 0.0);
	}
	return 0;
}
	...
	foreach(new i : Player)
	{
		...
		if(AccountData[i][pDuringCarsteal])
		{
			if(vehicleid == g_CarstealCarPhysic[i])
			{
				...
				ShowFivemNotify(i, "BLOKGEDONG Premiere~n~CAR STEAL", "Kendaraan carsteal telah hancur, misi dinyatakan gagal!", "hud:radar_qmark", 25);
			}
		}
	}
	...
	if(!AccountData[playerid][pInEvent])
	{
		if(issuerid != INVALID_PLAYER_ID)
		{
			if(IsPlayerInDynamicArea(playerid, AirportGreenZone) || AccountData[playerid][pInDoor] == 41 || AccountData[playerid][pInDoor] == 44)
			{
				...
				Dialog_Show(issuerid, "UnusedDialog", DIALOG_STYLE_MSGBOX, ""BLOKGEDONG"BLOKGEDONG "WHITE"- Anti Retard", ""RED"PERINGATAN KERAS!\n\n"YELLOW"Anda dilarang rusuh di area ini atau akan segera ditendang dari server!", "Tutup", "");
