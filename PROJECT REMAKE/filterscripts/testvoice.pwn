...
public OnPlayerConnect(playerid)
{
    ...
    else if (SvHasMicro(playerid) == SV_FALSE)
    {
		...
		Dialog_Show(playerid, "DialogNotUsed", DIALOG_STYLE_MSGBOX, "NEXOTIS "WHITE"- Mic Tidak Terdeteksi", lstring, "Quit", "");
...
public OnFilterScriptInit()
{
    ...
    print("-------------------- [NEXOTIS Voice Chat System] --------------------\n\
    ===>> Berhasil dimuat dengan baik!\n\
    ===>> by: mhyunata (M Wahyu Dinarta)\n\
    ===>> dipersembahkan untuk NEXOTIS\n\
    -------------------------------------------------------------------");
    return 1;
}
